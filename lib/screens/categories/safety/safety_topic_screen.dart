...
/// Generic categories-grid screen reused by all safety topics
/// (Emergency Signals, Risk Management, Wildlife Safety, Fire Safety).
class SafetyTopicScreen extends StatelessWidget {
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  ...
                  final lesson = _lessonForCategory(cat.id);
                  return _SafetyTopicCard(
                    category: cat,
                    onTap: lesson != null
                        ? () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => SafetyLessonScreen(
                                  category: cat,
                                  lesson: lesson,
                                ),
                              ),
...
// ── Category grid card ────────────────────────────────────────
class _SafetyTopicCard extends StatelessWidget {
  final SafetyCategory category;
  final VoidCallback? onTap;

  const _SafetyTopicCard({required this.category, this.onTap});
